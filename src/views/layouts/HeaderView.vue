...
@Options({
  watch: {
    currentWindowSize: (value) => {
      console.log("currentWindowSize ", value);
    },
...
export default class Header extends Vue {
  ...
  public async mounted(): Promise<void> {
    ...
    console.log("this.headerElement ", this.headerElement);
  }

  public onToggleMenuSidebar(): void {
    console.log("onToggleMenuSidebar");
    this.watchLayoutChanges;
  ...
  get watchLayoutChanges() {
    console.log("watchLayoutChanges");
  ...
  // methods: {
  //   onToggleMenuSidebar(event): void {
